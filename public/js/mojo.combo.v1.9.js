...
console.log( res );
            ...
            case 'admin':
              ...
              case 'academic_agency_status':
                ...
                {
                case 'list':
                  $('#grid-academic_agency_status').data('kendoGrid').setDataSource(new kendo.data.DataSource({ data: res.data, page: 1, pageSize: 10 }));
                  break;
                case 'agency':
                ...
                case 'search':
                  if (res.data.summary) {
                    ...
                    for (var i=0; i<mojo.data.academic_agency_report_summary.length; i++) {
                      ...
                      console.log(mojo.data.academic_agency_report_summary[i]);
                  ...
                  if (res.data.pdf) {
                    ...
                    for (var i=0; i<mojo.data.academic_agency_report_pdf.length; i++) {
                      console.log(mojo.data.academic_agency_report_pdf[i]);
      ...
      case 'academic_agency_class':
        ...
        case 'import':
          ...
          for (var i=0; i<mojo.data.academic_agency_class_last.length; i++)
            mojo.html += '<option value="' + mojo.data.academic_agency_class_last[i]['id'] + '">' + mojo.data.academic_agency_class_last[i]['cname'] + '</option>';
          mojo.html += '</select>';
    ...
    mojo.watch_filladd = function() {
      ...
      mojo.grid.academic_agency_class_country.kendoGrid({
        ...
        columns: [
          ...
          { title: "總人次", attributes: { "class": "country_people" }, footerAttributes: { "class": "summary-country_people" }, width: "90px" },
          { field: "note", title: "其他" }, 
          { title: "&nbsp;", width: "200px", 
            command: [
              {   
    ...
    mojo.watch_fillmod = function() {
      ...
      mojo.grid.academic_agency_class_country = $('#grid-academic_agency_class_country').kendoGrid({ 
        ...
        columns: [
          ...
          { field: "new_male", title: "男新生", attributes: { "class": "country_new_male" }, footerAttributes: { "class": "summary-country_new_male" }, width: "90px" },
          { field: "new_female", title: "女新生", attributes: { "class": "country_new_female" }, footerAttributes: { "class": "summary-country_new_female" }, width: "90px" },
          { field: "people", title: "總人次", attributes: { "class": "country_people" }, footerAttributes: { "class": "summary-country_people" }, width: "90px" },
          { field: "note", title: "其他" }, 
          { title: "&nbsp;", width: "200px", 
            command: [
              {   
