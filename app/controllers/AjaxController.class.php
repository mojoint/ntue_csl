            ...
            case 'era_detail':
                ...
                foreach ($targets as $target) {
                    ...
                    if ($size) {
                        ...
                        $objPHPExcel->setActiveSheetIndex($cnt)->setCellValue('H' . $knt, number_format($major_sum[ 'S' ]['hours']));
                        $objPHPExcel->setActiveSheetIndex($cnt)->setCellValue('I' . $knt, number_format($major_sum[ 'S' ]['weekly']));
                        $objPHPExcel->setActiveSheetIndex($cnt)->setCellValue('J' . $knt, number_format($major_sum[ 'S' ]['total_hours']));
        ...
        case 'academic_agency_report':
            ...
            case 'detail':
                ...
                if ($size) {
                    ...
                    $objPHPExcel->setActiveSheetIndex($cnt)->setCellValue('H' . $knt, $major_sum[ 'A' ]['hours'] + $major_sum[ 'B' ][ 'hours' ] + $major_sum[ 'C' ][ 'hours' ]);
                    $objPHPExcel->setActiveSheetIndex($cnt)->setCellValue('I' . $knt, $major_sum[ 'A' ]['weekly'] + $major_sum[ 'B' ][ 'weekly' ] + $major_sum[ 'C' ][ 'weekly' ]);
