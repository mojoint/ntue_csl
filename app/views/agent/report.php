<section id="sec-agency_report">
    ...
    <?php if ($_SESSION['agent']) : ?>
      ...
      <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a id="tab-academic_agency_report_pdf" href="#academic_agency_report_pdf" aria-controls="academic_agency_report_pdf" role="tab" data-toggle="tab">PDF績效報表</a></li>
        <li role="presentation"><a id="tab-academic_agency_report_history" href="#academic_agency_report_history" aria-controls="academic_agency_report_history" role="tab" data-toggle="tab">歷史績效報表</a></li>
      </ul>    
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="academic_agency_report_summary">
          <script type="text/x-kendo-template" id="template-academic_agency_report_summary">
            <div class="createBtnContainer"><a href="\\#" class="k-button" id="btn-academic_agency_report_summary-export"><span class="fa fa-file-excel-o"></span>&nbsp;EXCEL報表</a></div>
        ...
        <div role="tabpanel" class="tab-pane" id="academic_agency_report_detail">
          <script type="text/x-kendo-template" id="template-academic_agency_report_detail">
            <div class="createBtnContainer"><a href="\\#" class="k-button" id="btn-academic_agency_report_detail-export"><span class="fa fa-file-excel-o"></span>&nbsp;EXCEL報表</a></div>
            <div class="toolbar"></div>
          </script>
        ...
        <div role="tabpanel" class="tab-pane" id="academic_agency_report_pdf">
          <script type="text/x-kendo-template" id="template-academic_agency_report_pdf">
            <div class="createBtnContainer"><a href="\\#" class="k-button" id="btn-academic_agency_report_pdf-export"><span class="fa fa-file-pdf-o"></span>&nbsp;PDF報表</a></div>
            <div class="toolbar"></div>
          </script>
        ...
        <div role="tabpanel" class="tab-pane" id="academic_agency_report_history">
          ...
          <div id="grid-academic_agency_report_history"></div>
        </div>
      </div>
      <script>
